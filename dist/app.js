...
const exitText = async () => {
    figlet.text("Thanks for using our Currency Converter App.", {
        font: "Standard",
...
const currencyConverter = async () => {
    ...
    const spinner = createSpinner(chalk.red(`Converting from ${firstCountry.select} to ${secondCountry.select}`)).start();
    await sleep();
    spinner.success({
